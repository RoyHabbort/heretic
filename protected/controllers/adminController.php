...
class adminController extends controllerClass {
    ...
    public function delete($params){
        ...
        if(!empty($_POST['delete'])){
            ...
            $text = $_POST['text'];
            if($result){
                heretic::redirect('success', '/admin/' . $page, $text .' удалён');
            }else{
                heretic::redirect('error', '/admin/edit' .$page . '/' . $idPageType, $text . ' удалить не удалось');
            }
        }else{
            errorClass::getPageError(404);
        }
    ...
    public function addPage($params){
        ...
        if(!empty($_POST)){
            ...
            if(empty($result['errors'])){
                heretic::redirect('success', '/admin/page', 'Добавлен материал');
            }else{
            ...
            $this->render('page/addPage', array('main_field' => $mainField, 'idPageType' => $idPageType, 'parent' => $parent, 'aux_field' => $auxField, 'result' => array('parent_id' => $parentId)));  
        }
    }
    ...
    public function editPage($params){
        ...
        if(!empty($_POST)){
            ...
            if(empty($result['errors'])){
                heretic::redirect('success', '/admin/page', 'Материал отредактирован');
            }else{
    ...
    public function deletePage($params){
        ...
        if(empty($result['errors'])){
                heretic::redirect('success', '/admin/page/', 'Материал удалён');
        }else{
            heretic::redirect('errors', '/admin/editPage/' . $idPage, 'Произошла ошибка. Удалить материал не удалось');
        }
    }
    ...
    public function addPageType(){
        ...
        if(!empty($_POST)){
            $result = $admin->AddInTable('page_type', $_POST, $rules = array(
                    'required' => 'title',
                    'string' => 'title, sort, type_parent_id'
                ));
            if(empty($result['errors'])){
                heretic::redirect('success', '/admin/pageType', 'Добавлен тип материала');
            }else{
...
//            exit;
            ...
            if(empty($result['errors'])){
                heretic::redirect('success', '/admin/pageType', 'Тип материала отредактирован');
            }else{
    ...
    public function deletePageType($params){
        ...
        if(!empty($_POST['delete'])){
            ...
            if($result){
                heretic::redirect('success', '/admin/pageType', 'Тип материала удалён');
            }else{
                heretic::redirect('error', '/admin/editPageType/' . $idPageType, 'Удалить тип материала не удалось');
            }
        }else{
            errorClass::getPageError(404);
        }
    ...
    public function addAuxField($params){
        ...
        if(!empty($_POST)){
            ...
            if(empty($result['errors'])){
                heretic::redirect('success', '/admin/editPageType/' . $idPageType, 'Поле добавлено');
            }else{
                heretic::redirect('errors', '/admin/editPageType/' . $idPageType, 'Произошла ошибка. Поле не добавлено');
            }
    ...
    public function deleteAuxField($params){
        ...
        if(empty($result['errors'])){
                heretic::redirect('success', '/admin/editPageType/' . $idPageType, 'Поле удалено');
        }else{
            heretic::redirect('errors', '/admin/editPageType/' . $idPageType, 'Произошла ошибка. Поле не удалено');
        }
    ...
    public function topMenu(){
        ...
        if(!empty($_POST)){
            ...
            if(empty($result['errors'])){
                heretic::redirect('success', '/admin/block', 'Блок верхнего меню отредактирован');
            }else{
    ...
    public function addField(){
        ...
        if(!empty($_POST)){
            ...
            if(empty($result['errors'])){
                heretic::redirect('success', '/admin/field', 'Дополнительное поле создано');
            }else{
                $this->render('field/addField', array('result' => $_POST, 'errors' => $result['errors'], 'field_type' => $fieldType, 'image_filter' => $imageFilter));
            }
        }else{
            $this->render('field/addField', array('field_type' => $fieldType, 'image_filter' => $imageFilter));
        }
    }
    ...
    public function editField($params){
        ...
        if(!empty($_POST)){
            ...
            if(empty($result['errors'])){
                heretic::redirect('success', '/admin/field', 'Дополнительное поле отредактированно');
            }else{
    ...
    public function deleteField($params){
        ...
        if(!empty($_POST['delete'])){
            ...
            if(empty($result['errors'])){
                heretic::redirect('success', '/admin/field', 'Дополнительное поле было удалено');
            }else{
                heretic::redirect('errors', '/admin/editField/' . $idField, 'При удалении произошла ошибка. Проверте БД.');
            }
        }else{
            errorClass::getPageError(404);
        }
    ...
    public function addImageFilter(){
        ...
        if(!empty($_POST)){
            ...
            if(empty($result['errors'])){
                heretic::redirect('success', '/admin/imageFilter', 'Фильтр создан');
            }else{
    ...
    public function editImageFilter($params){
        ...
        if(!empty($_POST)){
            ...
            if(empty($result['errors'])){
                heretic::redirect('success', '/admin/imageFilter', 'Фильтр отредактирован');
            }else{
    ...
    public function deleteImageFilter($params){
        ...
        if(!empty($_POST['delete'])){
            ...
            if(empty($result['errors'])){
                heretic::redirect('success', '/admin/imageFilter', 'Фильтр был удалён');
            }else{
                heretic::redirect('errors', '/admin/editImageFilter/' . $idImageFilter, 'При удалении произошла ошибка. Проверте БД.');
            }
        }else{
            errorClass::getPageError(404);
        }
    ...
    public function addSlider(){
        ...
        if(!empty($_POST)){
            ...
            if(empty($result['errors'])){
                heretic::redirect('success', '/admin/slider', 'Слайд добавлен');
            }else{
    ...
    public function editSlider($params){
        ...
        if(!empty($_POST)){
            ...
            if(empty($result['errors'])){
                heretic::redirect('success', '/admin/slider', 'Слайд изменён');
            }else{
    ...
    public function deleteSlider($params){
        ...
        if(!empty($_POST['delete'])){
            ...
            if($result){
                heretic::redirect('success', '/admin/slider', 'Слайд удалён');
            }else{
                heretic::redirect('error', '/admin/editSlider/' . $idSlider, 'Слайд удалить не удалось');
            }
        }else{
            errorClass::getPageError(404);
        }
    ...
    public function reviewSuccess($params){
        ...
        if(empty($result['errors'])){
            heretic::redirect('success', '/admin/review', 'Отзыв успешно одобрен');
        }else{
            heretic::redirect('error', '/admin/review', 'Отзыв одобрить не удалось');
        }
    ...
    public function deleteItems($params){
        ...
        if($result){
            heretic::redirect('success', '/admin/' . $redirect, 'Удаление прошло успешно');
        }else{
            heretic::redirect('error', '/admin/' . $redirect, 'Удалить не удалось');
        }
    ...
    public function options(){
        ...
        $signup = $model->getById('mail', 1);
        $kongress = $model->getById('mail', 2);
        
        $result = array(
            'signup' => $signup['mail'],
            'kongress' => $kongress['mail']
        );
        
        $this->render('options/options', array('result' => $result));
    ...
    /*
     * 5-12-2014
     * Смена адреса обратной связи
     * roy
     */
    
    public function mailEdit($params){
        $this->confirmRules();
        
        
        if(empty($_POST)||empty($params[0])){
            heretic::redirect('error', '/admin/options', 'Данные не переданы');
        }
        ...
        $result = $model->saveMail($newMail);
        
        if(empty($result['errors'])){
            heretic::redirect('success', '/admin/options', 'Новый адресс успешно сохранён');
        }else{
            heretic::redirect('error', '/admin/options', 'Сохранить адресс не удалось');
        }     
    ...
    public function restMenu(){
        ...
        $result = $model->getStructurMenu(); 
        
        $this->render('block/restMenu/restMenu', array('result' => $result));
    ...
    public function addCategoryMenu(){
        ...
        if(!empty($_POST)){
            ...
            $result = $model->addCategory($_POST);
            
            if(!empty($result['success'])){
                heretic::redirect('success', '/admin/restMenu', $result['success']);
            }
            
            $this->render('block/restMenu/addCategoryMenu', array('result' => $_POST, 'errors' => $result['errors']));
            
        }else{
            $this->render('block/restMenu/addCategoryMenu', array('result' => ''));
        }
    ...
    public function editCategoryMenu($params){
        $this->confirmRules();
        ...
        $category = $model->getById('restMenu', $categoryId);
        
        if(!empty($_POST)){
            $result = $model->editById('restMenu', $_POST, $rules = array(
                'required' => 'title',
                'string' => 'title, sort'
            ), $categoryId);
            
            if(empty($result['errors'])){
                heretic::redirect('success', '/admin/restMenu', 'Категория успешно отредактирована');
            }
            
            $post = $_POST;
            $post['id_restMenu'] = $categoryId;
            
            $this->render('block/restMenu/editCategoryMenu', array('result' => $post, 'errors' => $result['errors']));
            
        }else{
            $this->render('block/restMenu/editCategoryMenu', array('result' => $category));
        }
    ...
    public function addRestMenu($params){
        ...
        $parent = $model->getParentOption();
        
        if(!empty($_POST)){
            $result = $model->addRestMenu($_POST);
            
            if(!empty($result['success'])){
                heretic::redirect('success', '/admin/restMenu', $result['success']);
            }
            
            $this->render('block/restMenu/addRestMenu', array('result' => $_POST, 'categoryId' => $categoryId, 'parent' => $parent, 'errors' => $result['errors']));
            
        }else{
            $result = array('parent_id' => $categoryId);
            $this->render('block/restMenu/addRestMenu', array('result' => $result, 'categoryId' => $categoryId, 'parent' => $parent));  
        }
    ...
    public function editRestMenu($params){
        ...
        $currentMenu = $params[0];
        
        $model = new restMenu();
        
        $material = $model->getById('restMenu', $currentMenu);
        $parent = $model->getParentOption($currentMenu);
        
        if(!empty($_POST)){
            $result = $model->editRestMenu($_POST, $currentMenu);
            
            if(!empty($result['success'])){
                heretic::redirect('success', '/admin/restMenu', $result['success']);
            }
            
            $this->render('block/restMenu/editRestMenu', array('result' => $_POST, 'parent' => $parent, 'errors' => $result['errors']));
            
        }else{
            $this->render('block/restMenu/editRestMenu', array('result' => $material, 'parent' => $parent)); 
        }
    ...
    public function deleteRestMenu($params){
        ...
        $result = $model->deleteRestMenu($idRestMenu);
        
        if(!empty($result['errors'])){
            heretic::redirect('errors', '/admin/restMenu', $result['errors']);
