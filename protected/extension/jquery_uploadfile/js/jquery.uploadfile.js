...
(function ($) {
    ...
    if($.fn.ajaxForm == undefined) {
        ...
        $.getScript(document.location.protocol + "//" + document.location.hostname + "/protected/extension/jquery_uploadfile/js/lib/lib.js");
    }
    var feature = {};
    ...
    $.fn.uploadFile = function (options) {
        ...
        function createProgressDiv(obj, s) {
            this.statusbar = $("<div class='ajax-file-upload-statusbar file-upload-form'><div class='imp-pre'><img src='/template/admin/img/icons/pre.GIF'></div></div>");
            ...
            this.del = $("<div class='ajax-file-upload-red upload-delete'>" + s.deletelStr + "</div>").appendTo(this.statusbar).hide();
            if(s.showQueueDiv)
