<div class="content-width page-admin">
    ...
    <div class="admin-title block-padding">
        ...
        <div>
            <form method='post' action='/admin/deleteSlider/<?=$arguments['result']['id_slider']?>'>
    ...
    <div class="admin-page-block block-padding edit-page">
        ...
        <form  action="/admin/editSlider/<?=$arguments['result']['id_slider']?>"  method="post" name="edit-form" class="edit-form" enctype="multipart/form-data">
