<div class="content-width page-admin">
    ...
    <div class="admin-title block-padding">
        ...
        <div>
            <form method='post' action='/admin/deletePageType/<?=$arguments['result']['id_page_type']?>'>
    ...
    <div class="admin-page-block block-padding edit-page">
        ...
        <form  action="/admin/editPageType/<?=$arguments['result']['id_page_type']?>"  method="post" name="edit-form" class="edit-form" enctype="multipart/form-data">
    ...
    <div class="aux-field-block block-padding">
        ...
        <div class="aux-field">
            ...
            <div class="aux-field-one">
                ...
                <div class='aux-field-btn-del'>
                    <a class='btn btn-red' href='/admin/deleteAuxField/<?=$arguments['result']['id_page_type']?>/<?=$value['id_field']?>'>
                        Удалить
                    </a>    
                </div>    
            </div>    
        ...
        <div class="aux-field-add">
            <form method="post" name="aux-form" class="edit-form" action="/admin/addAuxField/<?=$arguments['result']['id_page_type']?>">
                <?php
                    $name = 'field_id';
                    heretic::Widget('input', array(
                        'type' => 'select',
