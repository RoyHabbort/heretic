<div class="content-width page-admin">
    ...
    <div class="admin-title block-padding">
        ...
        <div>
            <form method='post' action='/admin/deleteField/<?=$arguments['result']['id_field']?>/'>
    ...
    <div class="admin-page-block block-padding edit-page">
        ...
        <form  action="/admin/editField/<?=$arguments['result']['id_field']?>"  method="post" name="edit-form" class="edit-form" enctype="multipart/form-data">
