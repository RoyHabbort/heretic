<div class="content-width page-admin">
    ...
    <div class="admin-title block-padding">
        ...
        <a href='/admin/addImageFilter/' class='btn btn-green'>Добавить фильтр</a>
    </div>    
        ...
        <?php foreach ($arguments['result'] as $key => $value) : ?>
            <div class="admin-page block-padding">
                ...
                <div class="admin-page-btn">
                    <a href="/admin/editImageFilter/<?=$value['id_image_filter']?>" class="btn btn-blue">Редактировать</a>
                </div>    
            </div>    
        <?php endforeach;?>  
    <?php else :?>
