<div class="content-width page-admin">
    ...
    <div class="admin-title block-padding">
        Редактирование фильтра изображений &laquo;<?=$arguments['result']['image_filter_name'];?>&raquo;
        <div>
            <form method='post' action='/admin/deleteImageFilter/<?=$arguments['result']['id_image_filter']?>/'>
    ...
    <div class="admin-page-block block-padding edit-page">
        ...
        <form  action="/admin/editImageFilter/<?=$arguments['result']['id_image_filter']?>"  method="post" name="edit-form" class="edit-form" enctype="multipart/form-data">
