<div class="content-width page-admin">
    ...
    <div class="admin-title block-padding">
        ...
        <div>
            <form method='post' action='/admin/deletePage/<?=$arguments['result']['id_page']?>/'>
                <input type = 'hidden' name='delete' value='page'>
                <button type="submit" class="btn btn-red">Удалить материал</button>
            </form>    
        </div>    
    </div>    
    ...
    <div class="admin-page-block block-padding edit-page">
        ...
        <form  action="/admin/editPage/<?=$arguments['result']['id_page']?>/<?=$arguments['result']['page_type']?>"  method="post" name="page-edit-material" class="edit-form" enctype="multipart/form-data">
            ...
            <?php $this->innerPage('admin/input/input', $arguments)?>
